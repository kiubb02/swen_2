...
public class TradingHandlerImpl implements TradingHandler {
    @Override
    ...
    public boolean validateOwnership(String username, String card) throws SQLException {
        ...
        try {
            ...
            stmt.setBoolean(2, false); //deck cardsImpl cannot be traded
    ...
    public String changeOwnership(String username, String cardname) {
        ...
        try {
            ...
            stmt.setString(1, username);
            stmt.setString(2, cardname); //deck cardsImpl cannot be traded
